...
struct AppConfigTests {
    ...
    func defaults() {
        ...
        #expect(config.meetingRecordingSavePolicy == .always)
        ...
        #expect(config.meetingRecordingFileFormat == MeetingRecordingFileFormat.mp3.rawValue)
        #expect(config.resolvedMeetingRecordingFileFormat == .mp3)
        ...
        #expect(config.autoExportMarkdownEnabled == true)
        #expect(config.autoExportMarkdownFolderPath == AppConfig.defaultMeetingExportFolderPath)
        #expect(config.autoExportMarkdownContent == MeetingExportContent.transcript.rawValue)
        #expect(config.resolvedAutoExportMarkdownContent == .transcript)
